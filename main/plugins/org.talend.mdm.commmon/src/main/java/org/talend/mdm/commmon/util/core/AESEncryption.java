...
public class AESEncryption {
    ...
    public AESEncryption() {
        try {
            ...
            if (StringUtils.isEmpty(keyfile)) {
                ...
                keyfile = System.getProperty("catalina.base") + File.separator + "conf" + File.separator + "aeskey.dat";
                ...
                if (file.exists()) {
                    ...
                    if (StringUtils.isEmpty(config.getString(ENCRYPTION_KEY))) {
                        config.setProperty(ENCRYPTION_KEY, EncodingUtils.BASE64_ENCODER.apply(KeySources.random(32).getKey()));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOGGER.info(encryptionTool.encrypt(args[0]));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
