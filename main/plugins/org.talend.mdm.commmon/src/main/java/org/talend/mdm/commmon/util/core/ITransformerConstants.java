...
public interface ITransformerConstants {

    public static final String VARIABLE_DEFAULT = "_DEFAULT_"; //$NON-NLS-1$
	...
	public static final String VARIABLE_OUTPUT_FOR_SMARTVIEW = "html"; //$NON-NLS-1$
